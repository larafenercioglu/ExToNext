...
import static extonextgroup.extonext_v2.AfterDonationScreenCorp.id;
import static extonextgroup.extonext_v2.AfterDonationScreenCorp.user;
import static extonextgroup.extonext_v2.LoginScreen.infoBox;
...
public class ItemDetailsPage extends javax.swing.JFrame {
    ...
    static String itempicurl;
    static String detailalfa;
    static String itempricebeta;
    static String textdat;
    ...
    public void setItemPic(String a)
    {
        itempicurl = a;
    }
    ...
    public void paintPage() {
        itempic.setIcon( new ImageIcon(itempicurl));
        itempic.setText("");
        itemdetails.setText(detailalfa);
        itempricelabel.setText(itempricebeta);
        itemname.setText(textdat);
        if(!check) {
...
//        
//        if ( x){
//         itemlist.add(a.get(n*4));
//         itemlist.add(a.get(n*4 + 1));
//         itemlist.add(a.get(n*4 + 2));
//         itemlist.add(a.get(n*4 + 3));
//        }
//        else {
...
//    }
    ...
    private void initComponents() {
        ...
        itemname.setFont(new java.awt.Font("Dialog", 1, 21)); // NOI18N
                    ...
                    .addGroup(itemDetailBackground1Layout.createSequentialGroup()
                        ...
                        .addGroup(itemDetailBackground1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(itemDetailBackground1Layout.createSequentialGroup()
                                ...
                                .addGap(214, 624, Short.MAX_VALUE))
                            .addGroup(itemDetailBackground1Layout.createSequentialGroup()
                                ...
                                .addGroup(itemDetailBackground1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, itemDetailBackground1Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(itemname, javax.swing.GroupLayout.PREFERRED_SIZE, 296, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(97, 97, 97))))))))
        );
    ...
    private void buybuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buybuttonActionPerformed
        // TODO add your handling code here:
        try {
        db.buyAndExchange(user,itempicurl);
        infoBox("Successfully bought.","succeeed!");
        } catch (Exception e) {
...
try{
        recievername = db.getUserNameFromDId(parseInt(id));
         
       JFrame frame = new JFrame("Message");
       String nextmessage = JOptionPane.showInputDialog(frame, "Enter your message:");  
       db.sendMessage(user, recievername,nextmessage );
       System.out.println(db.showMessages(user, recievername));
    ...
    private void addfavbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addfavbuttonActionPerformed
        // TODO add your handling code here:
        try {
        db.addToFavorites(user,itempicurl);
        infoBox("Succesfully added to fav","Succeed!");
        } catch (Exception e) {
            e.getMessage();
        }
