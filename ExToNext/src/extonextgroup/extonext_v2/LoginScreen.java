...
public class LoginScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/extonextgroup/extonext_v2/images/loginimage.png"))); // NOI18N
    ...
    //if ( login(UsernameField.getText(),UserPasswordField.getText()))
    //{
    //    infoBox("Successfuly logged in", "Log in");
    //    new MainPage.setUser(UsernameField.getText());
    //}
    //else
    //{
    //    infoBox("Log in failed. Wrong user name or password", " Error" );
    //}
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
           if(db.logIn(UsernameField.getText(),UserPasswordField.getText())) {
           
            
        if ( PersonalRadio.isSelected()  )
        {
            if ( db.personOrCorporation(UsernameField.getText()) == 1) {
                this.hide();
            ...
            personal.setUser(user);
                ...
                infoBox("wrong username or password","error");
            }
        }
        else if ( CorporationRadio.isSelected() )
        {
            if ( db.personOrCorporation(UsernameField.getText()) == 2) {
                this.hide();
