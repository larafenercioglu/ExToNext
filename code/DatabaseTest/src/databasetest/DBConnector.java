...
"WHERE di.d_item_id = " + donationItemId);
    ...
    //ArrayList(0) = username, ArrayList(1) = name, ArrayList(2) = e mail, ArrayList(3) = address, ArrayList(4) = phone ArrayList(5) = image
...
"    order by m_id");
    ...
    //Person Pages...
    //ArrayList(0) = user name, ArrayList(1) = name, ArrayList(2) = email,ArrayList(3) = address,ArrayList(4) = phone, ArrayList(5) = image
